  ...
  <div>
    <div class="guidance-wrapper">
      <div class="filter-wrapper" v-if="showFetch === true">
        <div class="filter">
          <img height="62%" src="./tickets-zhang.jpg" alt="">
          <div class="guidance-info">
            <ul>
              <li>
                <h3>活动时间</h3>
                <div>2017年10月31日至11月7日</div>
              </li>
              <li>
                <h3>活动对象</h3>
...
import TicketResult from 'Zcomponents/ticket-result/ticket-result'
import { getMyTicket, exchangeTicket } from 'api/zhangxueyou'
...
export default {
  ...
  methods: {
    _getTickets() {
      /* eslint-disable */
      var time = moment().isAfter('2017-11-07 23:59:59')
      if (time) {
        MessageBox('提示', '活动已结束，感谢您的参与')
        return
      }
/*      else {
        MessageBox('提示', '张学友演唱会还未开始，敬请期待')
        return
      }*/
