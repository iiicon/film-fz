<template>
  <transition name="slide">
    <div class="info-wrapper" ref="wrapper" style="overflow:scroll">
      <!-- <scroll ref="infoWrapper" class="infoview" :click="click" @scroll="scroll" :listen-scroll="listenScroll" :probe-type="probeType"> -->
      <div class="info" ref="info">
        <div class="head">
          ...
          <div class="desc">
            ...
            <div class="disc">
              <p>演出时间：12月1日 - 12月3日</p>
              <p style="margin-top: 10px">演出场馆：大连大麦体育文化中心</p>
              <!--<p>地址：xxx</p>-->
            </div>
          </div>
        </div>
        ...
        <div class="delivery-info" id="deliveryInfo" ref="deliveryInfo" v-on:focusin.stop="scrollFormToTop" v-on:focusout.stop="cancelScrollTop">
          <mt-cell title="配送方式：快递" class="mt-cell"></mt-cell>
          ...
          <div class="info-item border-bottom " id="view">
            <div class="left">
              <span>电话：</span>
            </div>
            <div class="right">
              <input type="tel" placeholder="请输入收货人手机号码" v-model="phone" maxlength="11">
            </div>
          </div>
          <div class="info-item border-bottom ">
            <div class="left">
          ...
          <div class="info-item">
            ...
            <div class="right">
              <input type="text" placeholder="请输入收货人详细地址" v-model="detailAddr">
            </div>
          </div>
        </div>
        <div class="message">
...
import { exchangeTicket } from 'api/zhangxueyou'
...
.info-wrapper {
  ...
  .head {
    ...
    .icon {
      flex: 110px 0 0;
      height: 160px;
      @include bg-image('./ui-header-zhang');
