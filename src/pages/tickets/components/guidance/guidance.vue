...
import TicketResult from 'Tcomponents/ticket-result/ticket-result'
import { getMyTicket, exchangeTicket } from 'api/tickets'
...
export default {
  ...
  methods: {
    _getTickets() {
      let time = moment().isAfter('2017-10-17 23:59:59')
      if (time) {
