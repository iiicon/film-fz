...
import TicketResult from 'Scomponents/ticket-result/ticket-result'
import { getMyTicket, exchangeTicket } from 'api/shenzhen'
...
export default {
  ...
  methods: {
    _getTickets() {
      /* eslint-disable */
      var timer = moment().isAfter('2017-11-30 23:59:59')
      if (timer) {
